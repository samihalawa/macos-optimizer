...
macOS Optimizer is released under the MIT License, giving you the freedom to use, modify, and distribute it as you see fit. See the [LICENSE](LICENSE) file for more details.
